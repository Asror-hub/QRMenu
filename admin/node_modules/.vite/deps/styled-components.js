...
var M = j ? /* @__PURE__ */ Symbol.for("react.memo") : 60115;
var V = j ? /* @__PURE__ */ Symbol.for("react.forward_ref") : 60112;
...
var Xe = Je.Consumer;
function Ze() {
  var e = h ? void 0 : import_react.default.useContext(Je);
  if (!e) throw se(18);
  return e;
}
function Ke(e) {
  if (h) return e.children;
  var n = import_react.default.useContext(Je), r2 = import_react.default.useMemo(function() {
    return (function(e2, n2) {
      if (!e2) throw se(14);
      if (X(e2)) {
        var o2 = e2(n2);
        if (null === o2 || Array.isArray(o2) || "object" != typeof o2) throw se(7);
        return o2;
      }
      if (Array.isArray(e2) || "object" != typeof e2) throw se(8);
      return n2 ? __assign(__assign({}, n2), e2) : e2;
    })(e.theme, n);
  }, [e.theme, n]);
  return e.children ? import_react.default.createElement(Je.Provider, { value: r2 }, e.children) : null;
}
var Qe = {};
var et = /* @__PURE__ */ new Set();
function tt(e, s, i) {
  var a2 = Z(e), c2 = e, u2 = !k(e), d2 = s.attrs, p2 = void 0 === d2 ? S : d2, f2 = s.componentId, m2 = void 0 === f2 ? (function(e2, t) {
  ...
  })(e) : y2, N2 = s.displayName && s.componentId ? "".concat(A(s.displayName), "-").concat(s.componentId) : s.componentId || m2, C2 = a2 && c2.attrs ? c2.attrs.concat(p2).filter(Boolean) : p2, P2 = s.shouldForwardProp;
  ...
  function D2(e2, s2) {
    return (function(e3, s3, i2) {
      var a3 = e3.attrs, c3 = e3.componentStyle, u3 = e3.defaultProps, l2 = e3.foldedComponentIds, d3 = e3.styledComponentId, p3 = e3.target, f3 = h ? void 0 : import_react.default.useContext(Je), m3 = Ve(), y3 = e3.shouldForwardProp || m3.shouldForwardProp;
...
function ut(n) {
  for (var r2 = [], s = 1; s < arguments.length; s++) r2[s - 1] = arguments[s];
  var i = rt.apply(void 0, __spreadArray([n], r2, false)), a2 = "sc-global-".concat(R(JSON.stringify(i))), c2 = new ct(i, a2);
  g(a2);
  var u2 = /* @__PURE__ */ new WeakMap(), l2 = function(e) {
    var n2 = Ve(), r3 = h ? void 0 : import_react.default.useContext(Je), s2 = u2.get(n2.styleSheet);
    if (void 0 === s2 && (s2 = n2.styleSheet.allocateGSInstance(a2), u2.set(n2.styleSheet, s2)), import_react.default.Children.count(e.children) && console.warn("The global style component ".concat(a2, " was given child JSX. createGlobalStyle does not render children.")), i.some(function(e2) {
      return "string" == typeof e2 && -1 !== e2.indexOf("@import");
    }) && console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."), ("undefined" == typeof window || !n2.styleSheet.server) && (function(e2, n3, o2, r4, s3) {
      if (c2.isStatic) c2.renderStyles(e2, m, o2, s3);
      else {
        var i2 = __assign(__assign({}, n3), { theme: b(n3, r4, l2.defaultProps) });
        c2.renderStyles(e2, i2, o2, s3);
      }
    })(s2, e, n2.styleSheet, r3, n2.stylis), !h) {
      var d2 = import_react.default.useRef(true);
      import_react.default.useLayoutEffect(function() {
        return d2.current = false, function() {
          d2.current = true, queueMicrotask(function() {
            d2.current && (c2.removeStyles(s2, n2.styleSheet), "undefined" != typeof document && document.querySelectorAll('style[data-styled-global="'.concat(a2, '"]')).forEach(function(e2) {
              return e2.remove();
            }));
          });
        };
    ...
    if (h) {
      var p2 = a2 + s2, f2 = "undefined" == typeof window ? n2.styleSheet.getTag().getGroup(de(p2)) : "";
      if (f2) {
        var y2 = "".concat(a2, "-").concat(s2);
        return import_react.default.createElement("style", { key: y2, "data-styled-global": a2, precedence: "styled-components", href: y2, children: f2 });
      }
    }
    return null;
  };
...
function lt(t) {
  ...
  var r2 = Q(rt.apply(void 0, __spreadArray([t], n, false))), s = R(r2);
  return new Le(s, r2);
}
function dt(e) {
  var n = import_react.default.forwardRef(function(n2, r2) {
    var s = b(n2, h ? void 0 : import_react.default.useContext(Je), e.defaultProps);
    return void 0 === s && console.warn('[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class "'.concat(x(e), '"')), import_react.default.createElement(e, __assign(__assign({}, n2), { theme: s, ref: r2 }));
  });
...
var ht = { StyleSheet: Ae, mainSheet: Te };
...
export {
  ...
  Ke as ThemeProvider,
  ht as __PRIVATE__,
  ut as createGlobalStyle,
  rt as css,
  at as default,
  Z as isStyledComponent,
  lt as keyframes,
  at as styled,
  Ze as useTheme,
  l as version,
